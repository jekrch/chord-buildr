import {getNoteNumberChord, getNoteLettersChord} from './chordManager';
...
it('getNoteLettersChord: return chord letters from key, root note, and type', () => {
    ...
    expect(getNoteLettersChord('c', 1, '')).toEqual(["C","E","G"]);
    expect(getNoteLettersChord('C', 2, 'm')).toEqual(["C#","E","G#"]);
    expect(getNoteLettersChord('F', 2, 'm')).toEqual(["Db","E","Ab"]);
    expect(getNoteLettersChord('F#', 7, 'maj7')).toEqual(["F#","A#","C#","F"]);
    expect(getNoteLettersChord('Ab', 7, 'maj7')).toEqual(["Gb","Bb","Db","F"]);
    expect(getNoteLettersChord('Ab', 3, '+')).toEqual(["D", "Gb", "Bb"]);
    expect(getNoteLettersChord('E', 3, '+')).toEqual(["D", "F#", "A#"]);
