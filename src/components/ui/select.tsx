...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "bg-slate-300/10 bg-opacity-50 px-3 py-2 text-sm shadow-sm ring-offset-background " + 
...
>(({ className, children, value = "", ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "h-9 relative flex w-full cursor-default select-none items-center rounded-sm " +
      "py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-primary focus:text-accent-foreground " +
